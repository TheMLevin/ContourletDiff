...
# ----------------- Contourlet -----------
if [[ $MODE == train ]]; then
	echo "==> Training ContourletDiff"

	if [[ $DATASET == cifar10 ]]; then
		python train_cddgan.py --dataset cifar10 --exp cddgan_cifar10_exp1_noatn_g122_d3_recloss_1800ep --num_channels_dae 128 --num_timesteps 4 \
		...
		python train_cddgan.py --dataset celeba_512 --image_size 512 --exp cddgan_celebahq512_exp1_atn16_cg112244_d6_recloss_400ep --num_channels_dae 64 --ch_mult 1 1 2 2 4 4 --num_timesteps 2 \
		...
		python train_cddgan.py --dataset celeba_1024 --image_size 1024 --exp cddgan_celebahq1024_exp1_cg112244_d6_recloss_400ep --num_channels_dae 64 --ch_mult 1 1 2 2 4 4 --num_timesteps 2 --patch_size 2 \
			--num_res_blocks 2 --batch_size 4 --num_epoch 400 --ngf 64 --embedding_type positional --use_ema --r1_gamma 2. \
		...
		python train_cddgan.py --dataset lsun --image_size 256 --exp cddgan_lsun_exp1_cg12224_d5_recloss_500ep --num_channels_dae 64 --ch_mult 1 2 2 2 4 --num_timesteps 4 \
	...
	if [[ $DATASET == cifar10 ]]; then \
		...
		python test_cddgan.py --dataset stl10 --exp cddgan_stl10_exp1_atn16_cg1222_d4_recloss_900ep --num_channels_dae 128 --num_timesteps 4 \
		...
		python test_cddgan.py --dataset celeba_256 --image_size 256 --exp cddgan_celebahq_exp1_atn16_cg12224_d5_recloss_500ep --num_channels_dae 64 \
		...
		python test_cddgan.py --dataset celeba_512 --image_size 512 --exp cddgan_celebahq512_exp1_atn16_cg112244_d6_recloss_400ep --num_channels_dae 64 \
		...
		python test_cddgan.py --dataset celeba_1024 --image_size 1024 --exp cddgan_celebahq1024_exp1_cg112244_d6_recloss_400ep --num_channels_dae 64 \
			--ch_mult 1 1 2 2 4 4 --num_timesteps 2 --num_res_blocks 2  --epoch_id 350 \
		...
		python test_cddgan.py --dataset lsun --image_size 256 --exp cddgan_lsun_exp1_cg12224_d5_recloss_500ep --num_channels_dae 64 \
