...
def sample_and_test(args):
    ...
    ckpt = torch.load('./saved_info/cdd_gan/{}/{}/netG_{}.pth'.format(
    ...
    save_dir = "./cddgan_generated_samples/{}".format(args.dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--contourlet_nlevs", type=int, default=2,
                        help='number of levels for contourlet decomposition (default: 2, gives 4 directional subbands)')
